...
export const metadata: Metadata = {
  title: "CafeBrew - Premium Specialty Coffee Cafe",
  description: "Experience exceptional specialty coffee crafted by expert baristas. Premium beans, artisan brewing methods, and a welcoming atmosphere.",
  keywords: "specialty coffee, cafe, espresso, latte art, coffee shop, barista",
  metadataBase: new URL("https://cafebrew.com"),
  alternates: {
    canonical: "https://cafebrew.com"
  },
  openGraph: {
    title: "CafeBrew - Premium Specialty Coffee",
    description: "Discover the finest specialty coffee experience. Visit our cafe for expertly crafted beverages.",
    siteName: "CafeBrew",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763973773619-6c1gzkpc.jpg",
      alt: "CafeBrew specialty coffee"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "CafeBrew - Premium Coffee Cafe",
    description: "Experience exceptional specialty coffee crafted with care and expertise.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763973774482-uko4rt4v.jpg"]
  }
};
